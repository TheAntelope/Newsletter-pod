...
class Settings(BaseSettings):
    ...
    podcast_host_primary_name: str = Field(default="Demi", alias="PODCAST_HOST_PRIMARY_NAME")
    podcast_host_secondary_name: str = Field(default="Vinnie", alias="PODCAST_HOST_SECONDARY_NAME")
