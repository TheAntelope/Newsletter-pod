...
class Settings(BaseSettings):
    ...
    free_max_delivery_days: int = Field(default=1, alias="FREE_MAX_DELIVERY_DAYS")
    paid_max_delivery_days: int = Field(default=3, alias="PAID_MAX_DELIVERY_DAYS")
    free_min_duration_minutes: int = Field(default=5, alias="FREE_MIN_DURATION_MINUTES")
