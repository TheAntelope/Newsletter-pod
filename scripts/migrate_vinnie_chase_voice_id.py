"""One-shot: re-point every podcast profile from the old Vinnie Chase
ElevenLabs voice ID to the new one. Users who explicitly picked Vinnie
...
Usage (PowerShell):
    ...
    python scripts/migrate_vinnie_chase_voice_id.py            # dry-run
    python scripts/migrate_vinnie_chase_voice_id.py --apply    # write
"""
...
OLD_VOICE_ID = "hYjzO0gkYN6FIXTHyEpi"
NEW_VOICE_ID = "suMMgpGbVcnihP1CcgFS"
